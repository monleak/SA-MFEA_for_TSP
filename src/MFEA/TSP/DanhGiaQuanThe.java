...
public class DanhGiaQuanThe {
    public static void tinhKhoangCach(NST temp){
        ...
        for(int gene=1;gene<totalCities;gene++){
            if(temp.Gen[gene]<=25){
                luuDanhSach25Dinh[dem] = temp.Gen[gene];
                dem++;
            }
        }
